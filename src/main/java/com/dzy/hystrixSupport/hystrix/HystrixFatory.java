package com.dzy.hystrixSupport.hystrix;
...
public class HystrixFatory {
	...
	public HystrixFatory(HystrixConfig config) {
		this.config = config;
	...
	public HystrixCommand<Object> create(MethodProxy methodProxy, Object obj, Object[] params, Method failMethod, Object target) {
		...
		HystrixCommand<Object> command = new HystrixCommand<Object>(HystrixCommand.Setter
